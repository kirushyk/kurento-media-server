...
public:
  ...
  RTCCertificateStats (const std::string &id, std::shared_ptr<StatsType> type, double timestamp, const std::string &fingerprint, const std::string &fingerprintAlgorithm, const std::string &base64Certificate, const std::string &issuerCertificateId) : RTCStats (id, type, timestamp) {
