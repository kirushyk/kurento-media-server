...
public:
  ...
  RTCIceCandidatePairStats (const std::string &id, std::shared_ptr<StatsType> type, double timestamp, const std::string &transportId, const std::string &localCandidateId, const std::string &remoteCandidateId, std::shared_ptr<RTCStatsIceCandidatePairState> state, int64_t priority, bool nominated, bool writable, bool readable, int64_t bytesSent, int64_t bytesReceived, double roundTripTime, double availableOutgoingBitrate, double availableIncomingBitrate) : RTCStats (id, type, timestamp) {
