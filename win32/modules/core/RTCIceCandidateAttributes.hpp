...
public:
  ...
  RTCIceCandidateAttributes (const std::string &id, std::shared_ptr<StatsType> type, double timestamp, const std::string &ipAddress, int64_t portNumber, const std::string &transport, std::shared_ptr<RTCStatsIceCandidateType> candidateType, int64_t priority, const std::string &addressSourceUrl) : RTCStats (id, type, timestamp) {
