...
public:
  ...
  RTCTransportStats (const std::string &id, std::shared_ptr<StatsType> type, double timestamp, int64_t bytesSent, int64_t bytesReceived, const std::string &rtcpTransportStatsId, bool activeConnection, const std::string &selectedCandidatePairId, const std::string &localCertificateId, const std::string &remoteCertificateId) : RTCStats (id, type, timestamp) {
