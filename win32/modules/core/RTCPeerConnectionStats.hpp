...
public:
  ...
  RTCPeerConnectionStats (const std::string &id, std::shared_ptr<StatsType> type, double timestamp, int64_t dataChannelsOpened, int64_t dataChannelsClosed) : RTCStats (id, type, timestamp) {
